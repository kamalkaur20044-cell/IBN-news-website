    ...
    <>
      ...
      <div className=" h-[62px] overflow-hidden border-t-[4px] border-b-[4px] border-red-800">
        ...
        <div className="relative flex h-[36px] items-center flex-1 overflow-hidden bg-gray-100">
          <div className="ticker-animation flex h-full items-center shrink-0 gap-20 whitespace-nowrap font-medium tracking-[2px]">
            <span className="text-sm font-medium">Latest Updates From Across India</span>
            <span className="text-sm font-medium">India Wins Today's Cricket Match</span>
            <span className="text-sm font-medium">Punjab Government Announces New Policy</span>
            <span className="text-sm font-medium">India Wins Cricket Match</span>
          </div>
          <div className="absolute right-0 top-0 z-20 flex h-ful w-[300px] items-center justify-center bg-[#c80000] pl-8 text-[21px] font-bold text-white  [clip-path:polygon(12%_0,100%_0,92%_100%,0_100%)]">
            BREAKING NEWS
          </div>
        </div>
      </div>
